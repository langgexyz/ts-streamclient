...
import { Utf8, UniqFlag, ConsoleLogger, Second } from "ts-xutils";
...
export class Client {
    constructor(protocolCreator, logger = ConsoleLogger) {
        ...
        this.flag = UniqFlag();
        this.netMutex = new Mutex();
        logger.w.info(logger.f.Info(`Client[${this.flag}].new`, `flag=${this.flag}`));
        this.net_ = this.newNet();
    }
    newNet() {
        return new Net(this.logger, this.protocolCreator, (err) => __awaiter(this, void 0, void 0, function* () {
