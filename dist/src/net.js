...
import { Second, UniqFlag, Utf8 } from "ts-xutils";
import { asyncExe, Channel, Mutex, Semaphore, withTimeout, Timeout } from "ts-concurrency";
import { Response, Request, Status as ResStatus } from "./fakehttp";
import { ElseConnErr, ElseErr } from "./error";
...
export class Net {
    ...
    closeAndOldState(err) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.allRequests.ClearAllWith([Response.ZeroRes(), err.toConnErr]);
            return old;
        });
    }
    onError(err) {
    ...
    send(data_1, headers_1) {
        return __awaiter(this, arguments, void 0, function* (data, headers, timeout = 30 * Second) {
            // 预判断
            ...
            let ret2 = yield withTimeout(timeout, () => __awaiter(this, void 0, void 0, function* () {
                asyncExe(() => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    let err = yield this.proto.Send(request.encodedData);
                    if (err) {
                        yield ((_a = this.allRequests.Remove(reqId)) === null || _a === void 0 ? void 0 : _a.Send([Response.ZeroRes(), err]));
                    }
                }));
            ...
            if (ret2 instanceof Timeout) {
                this.logger.w.debug(this.logger.f.Debug(`Net[${this.flag}]<${this.connectID}>.send[${reqId}]:Timeout`, `headers:${formatMap(headers)} (reqId:${reqId}) --- timeout(>${timeout / Second}s)`));
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            let old = yield this.closeAndOldState(new ElseErr("closed by self"));
            if (old instanceof Connected) {
                this.logger.w.debug(this.logger.f.Debug(`Net[${this.flag}]<${this.connectID}>.close`, "closed, become invalidated"));
                yield this.proto.Close();
            }
