...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./net", "ts-xutils", "ts-concurrency"], factory);
    }
    ...
    class Client {
        ...
        Send(data_1, headers_1) {
            return __awaiter(this, arguments, void 0, function* (data, headers, timeout = 30 * ts_xutils_1.Second) {
                ...
                this.logger.w.debug(this.logger.f.Info(`Client[${this.flag}].Send[${sflag}]:start`, `headers:${(0, net_1.formatMap)(headers)}, request utf8 size = ${utf8Data.byteLength}`));
